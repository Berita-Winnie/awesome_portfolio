...
const Design = () => {
  return (
    <div className="container mx-auto w-full overflow-hidden  pt-80 md:pt-60  lg:px-30 items-center">
      <div className="flex flex-col md:flex-row  gap-38  sm:gap-6 lg:gap-40 justify-center items-center">
